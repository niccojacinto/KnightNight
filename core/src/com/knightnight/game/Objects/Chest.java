 ...
 */
public class Chest extends Sprite implements IPosition {

    private static KnightNight game;
    private static Texture tex = new Texture("Objects/chest.gif");

    public Chest(KnightNight _game, int x, int y) {
        super(tex);
        game = _game;
